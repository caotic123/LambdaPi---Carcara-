...
However, dispatching problems to SMT solvers and reconstructing proofs still require proof-assistant specific encodings to the SMT-LIB format \cite{smtlib}.
