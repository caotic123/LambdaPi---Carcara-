...
A more practical approach is proof logging where a reasoner emits a proof artifact justifying its output, enabling independent verification \cite{prooflogging}.
